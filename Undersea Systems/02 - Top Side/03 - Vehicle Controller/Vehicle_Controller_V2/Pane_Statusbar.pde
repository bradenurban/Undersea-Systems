...
class CameraCan {
  ...
  void update(){
      fill(background);
      rect(CC_zero_x, CC_zero_y, CC_pane_W, CC_pane_H);
      ...
      dot_gauge(CC_zero_x+290, CC_center_y-10, "Valid",true,"Leak");
      dot_gauge(CC_zero_x+290, CC_center_y+40, "Valid",true,"Comm's");
...
void dot_gauge(int x_loc, int y_loc, String state, Boolean value, String Label){
    int D = 25;
    stroke(0);
    strokeWeight(1);
    fill(0);
